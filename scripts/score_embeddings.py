...
if __name__ == "__main__":
    ...
    with open(args.output, "wt") as ofd:
        ...
        ofd.write(json.dumps({"reference_similarity" : s_ref_dists, "nonreference_similarity" : s_nonref_dists, "ratio" : s_ref_dists / s_nonref_dists, "num_refs" : len(ref_dists), "file_name" : args.embeddings}) + "\n")
